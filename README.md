...
管理者（MASTER / SUPPORT）は、ユーザー管理画面から新規ユーザーを追加できます。

**動作確認手順**:

1. 管理者でログイン（master@test.com または support@test.com、パスワード: password123）
2. 設定 → ユーザー管理 に移動
3. 「新規ユーザー追加」ボタンをクリック
4. 必要情報を入力して作成
5. 作成後、一覧に即座に反映されることを確認
6. 作成したユーザーでログインできることを確認

**権限確認**:

- MEMBER / GOVERNMENT でログインした場合、「新規ユーザー追加」ボタンは表示されません
- APIを直接呼び出すと403エラーが返されます
