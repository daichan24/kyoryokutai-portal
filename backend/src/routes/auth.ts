...
router.post('/login', loginRateLimit, async (req, res) => {
  try {
    ...
    const userResponse: any = {
      ...
      notepadEnabled: user.notepadEnabled !== false,
      contactsSidebarEnabled: user.contactsSidebarEnabled === true,
      ...
      scheduleDefaultView: user.scheduleDefaultView ?? null,
      scheduleHoverHighlightEnabled: user.scheduleHoverHighlightEnabled !== false,
