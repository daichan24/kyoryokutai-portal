            ...
            >
              <div className="flex items-start justify-between">
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-gray-500 dark:text-gray-400">{project.user.name}</p>
                </div>
                <div className="flex flex-col gap-1 items-end">
                  <span className="text-xs px-2 py-0.5 rounded bg-blue-100 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300">
                    {phaseLabels[project.phase] || project.phase}
                  </span>
                  <span className={`text-xs px-2 py-0.5 rounded ${statusColors[project.approvalStatus] || statusColors.DRAFT} dark:bg-gray-700 dark:text-gray-300`}>
