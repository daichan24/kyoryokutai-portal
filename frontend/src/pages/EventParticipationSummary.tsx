  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-2 text-gray-600 dark:text-gray-400">自分のイベント参加状況を確認できます</p>
      </div>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow border border-border dark:border-gray-700 p-6">
        <h2 className="text-xl font-semibold text-gray-900 dark:text-gray-100 mb-4">参加状況について</h2>
